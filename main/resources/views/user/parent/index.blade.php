		...
		<div class="row">
              ...
              <div class="card card-statistics">
                <div class="card-body">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">
                            ...
                            @if(!empty($mychild->student_class))
    
                                @foreach($mychild->student_class as $class)
                  ...
                  <p class="text-muted mt-3 mb-0">
                    <i class="mdi mdi-alert-octagon mr-1" aria-hidden="true"></i> This shows number of classes joined by your child.
                  </p>
                  <hr>
                  <h5>{{$mychild->user->name}}</h5>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 grid-margin stretch-card">
          ...
          <div class="row" id="score">
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-primary md-5">{{$mychild->user->name}}'s Running Classes</h4>
                    ...
                    <table class="table table-bordered" id="myTable">
                      ...
                      <tbody>
                        ...
                        @if(!empty($mychild->student_class))
                            ...
                            @foreach($mychild->student_class as $myclass)
